...
import { fetchBehaviors } from '../util/behavior';

const AdminBehaviorsPage = () => {
    ...
    const columns = useMemo(
      () => [
        ...
        // TODO: FIX SPACING IN TABLE TO HANDLE OVERFLOW - Implement FIX in other tables also
        {
...
export default AdminBehaviorsPage;